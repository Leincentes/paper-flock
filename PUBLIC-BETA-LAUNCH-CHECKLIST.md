# Paper Flock v1.6.0 — Controlled Beta Launch Checklist

## Before push

- Confirm `package.json` and `package-lock.json` both report 1.6.0.
...
- The v1.6.0 SBOM and archive attestation are created.
...
Do not mark v1.6.0 production-approved until CI evidence, both physical-device
